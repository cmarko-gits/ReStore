...
namespace API.Extensions
{
    public static class ProductExtensions 
    {
        ...
        {
            // Proverava da li je searchTerm prazan ili null
            if (string.IsNullOrEmpty(searchTerm)) return query;

            // Uklanja prazne karaktere sa krajeva i konvertuje u mala slova
            var lowerCaseSearchTerm = searchTerm.Trim().ToLower();

            // Filtrira proizvode gde naziv (Name) sadrži searchTerm
